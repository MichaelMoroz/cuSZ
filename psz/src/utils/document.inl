...
static const char psz_full_doc[] =
    ...
    "\n"
    "  ^^*optional::assessment*^^\n\n"
    "    *--origin* || *--compare* /path/to/origin-data\n"
    "        For verification & get data quality evaluation.\n"
    "        This automatically turns on data-quality assessment report.\n"
    "\n"
    "  ^^*optional::modules*^^\n\n"
    "    *-p* || *--pred* || *--predictor* <lrz|lrz-zz|lrz-proto|spl>\n"
    "        Select from the following predictors: \n"
    "        + _lrz_ || _lorenzo_: (default) Lorenzo predictor.\n"
    "        + _lrz-zz_ || _lorenzo-zigzag_: Lorenzo + ZigZag codec.\n"
    "        + _lrz-proto_ || _lorenzo-proto_: prototype that matches _lrz_.\n"
    "        + _spl_ || _spline_: spline interpolation (3D).\n"
    "\n"
    "    *--hist* || *--histogram* <generic|sparse>\n"
    ...
    "\n"
    "    *-c1* || *--codec* || *--codec1* <hf|fzgcodec>\n"
    "        Select from the following lossless codec: \n"
    "        _hf_ || _huffman_: (default) multibyte Huffman codec.\n"
    ...
    "\n"
    "  ^^*help::doc*^^\n\n"
    "    *-h* || *--help*  Query documentation.\n"
    "\n"
    "    *-v* || *--version*  Query build number.\n"
    "\n"
    "    *-V* || *--versioninfo* || *--query-env*  Query runtime.\n"
    // "\n"
    // "  ^^*config::string*^^\n\n"
    // "    *-c* || *--config* (option=value)-list\n"
    // "        syntax: opt=v, \"kw1=val1,kw1=val2[,...]\"\n"
    // "        + *eb*=<val>: error bound\n"
    ...
    "\n"
    "    # 2D *CESM* example (compression && decompression):\n"
    "    cusz -t f32 -m rel -e 1e-4 -i ${CESM} -l 3600-1800 -z --report "
    "time\n"
    "    cusz -i ${CESM}.cusza -x --report time --compare ${CESM}\n"
    "\n"
    "    # 3D *Hurricane Isabel* example (compression && decompression):\n"
    "    cusz -t f32 -m rel -e 1e-4 -i ${HURR} -l 500-500-100 -z\n"
    "    cusz -i ${HURR}.cusza -x\n";
...
static const char huff_re_short_doc[] =
    ...
    "1024\n"
    "    have to input dimension, && higher dimension for a multiplication "
    "of each dim.,\n"
